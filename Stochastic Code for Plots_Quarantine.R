...
initial_inf= 1 #input$initial_inf # initial infections
exogshock =0 #size of exogenous shock. 0 for no exogenous shocks, >1 for superspreader events
exograte = 0#4/30  # rate of exogenous shocks
...
Table <- matrix(c("% more than 1 case","Mean total cases if more than 1","% more than 1 isolated case",
                  ...
                  additional_cases,additional_cases_mean,isolated_number,isolated_average,isolated_max,quarantined_average, quarantined_max), ncol=2)
